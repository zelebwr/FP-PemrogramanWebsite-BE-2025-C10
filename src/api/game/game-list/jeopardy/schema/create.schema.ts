...
/**
 * Schema for a single clue in a category
 */
...
/**
 * Schema for a category with its clues
 */
...
/**
 * Schema for a round (Jeopardy, Double Jeopardy, or Final)
 */
...
/**
 * Schema for creating a new Jeopardy game
 */
export const CreateJeopardySchema = z.object({
...
export type ICreateJeopardy = z.infer<typeof CreateJeopardySchema>;
